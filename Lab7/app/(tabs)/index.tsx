...
import { auth } from '../firebaseConfig'; // Import cấu hình Firebase từ file bạn đã cung cấp

const AuthScreen = () => {
  // State để xác định đã lấy thông tin user thành công hay chưa
  const [initializing, setInitializing] = useState(true);
  // State lưu thông tin tài khoản user đã đăng nhập
  const [user, setUser] = useState<User | null>(null);
  // State lưu giá trị input từ người dùng
  ...
  useEffect(() => {
    // Đăng ký listener để theo dõi trạng thái đăng nhập
